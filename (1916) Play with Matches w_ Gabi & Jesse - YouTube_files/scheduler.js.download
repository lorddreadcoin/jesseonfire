...
var ba=aa(this);function l(a,b){if(b)a:{var c=ba;a=a.split(".");for(var d=0;d<a.length-1;d++){var e=a[d];if(!(e in c))break a;c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&b!=null&&k(c,a,{configurable:!0,writable:!0,value:b})}}
l("Symbol",function(a){function b(f){if(this instanceof b)throw new TypeError("Symbol is not a constructor");return new c(d+(f||"")+"_"+e++,f)}
function c(f,u){this.g=f;k(this,"description",{configurable:!0,writable:!0,value:u})}
if(a)return a;c.prototype.toString=function(){return this.g};
var d="jscomp_symbol_"+(Math.random()*1E9>>>0)+"_",e=0;return b});
l("Symbol.iterator",function(a){if(a)return a;a=Symbol("Symbol.iterator");k(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return ca(h(this))}});
return a});
...
if(typeof Object.setPrototypeOf=="function")m=Object.setPrototypeOf;else{var n;a:{var ha={a:!0},p={};try{p.__proto__=ha;n=p.a;break a}catch(a){}n=!1}m=n?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var q=m;
function r(a){var b=typeof Symbol!="undefined"&&Symbol.iterator&&a[Symbol.iterator];if(b)return b.call(a);if(typeof a.length=="number")return{next:h(a)};throw Error(String(a)+" is not an iterable or ArrayLike");}
l("Symbol.dispose",function(a){return a?a:Symbol("Symbol.dispose")});
function ia(a,b){a instanceof String&&(a+="");var c=0,d=!1,e={next:function(){if(!d&&c<a.length){var f=c++;return{value:b(f,a[f]),done:!1}}d=!0;return{done:!0,value:void 0}}};
e[Symbol.iterator]=function(){return e};
return e}
l("Object.values",function(a){return a?a:function(b){var c=[],d;for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&c.push(b[d]);return c}});
l("Array.prototype.values",function(a){return a?a:function(){return ia(this,function(b,c){return c})}});/*
...
L.prototype=fa(C.prototype);L.prototype.constructor=L;if(q)q(L,C);else for(var M in C)if(M!="prototype")if(Object.defineProperties){var N=Object.getOwnPropertyDescriptor(C,M);N&&Object.defineProperty(L,M,N)}else L[M]=C[M];function O(a,b){var c=Date.now();P(b);b=Date.now()-c;a.l||(a.o-=b)}
